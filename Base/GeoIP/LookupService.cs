  ...
  public class LookupService {
    ...
    public LookupService (String databaseFile, int options) {
      try {
        ...
        System.Console.Write("cannot open file " + databaseFile + "\n");
      }
    }
    ...
    public Location getLocation (long ipnum) {
      ...
      try {
        ...
        System.Console.Write("IO Exception while seting up segments");
      }
      return record;
    }
    ...
    public String getOrg (long ipnum) {
      ...
      try {
        ...
        System.Console.Write("IO Exception");
        return null;
      }
    }
    private int SeekCountry (long ipAddress) {
      ...
      System.Console.Write("Error Seeking country while Seeking " + ipAddress);
      return 0;
